##this program checks whethe__init__r a guest can enter a party iff he/she satifies the following condidtons
##a. guest must be Victoria  studentff ['[  1#b. be in the age range 18-25
